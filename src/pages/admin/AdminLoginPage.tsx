...
import { Lock, Tractor, ArrowRight, ShieldCheck, Key } from 'lucide-react';
      ...
      <div className="max-w-md w-full bg-gradient-to-b from-[#133E27] to-agro-dark rounded-3xl p-8 border border-agro-leaf/40 shadow-2xl space-y-6 text-left">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-gray-300 mt-1">
            Digite a senha de administrador para gerenciar anúncios, interessados e máquinas.
          </p>
        </div>

        {error && (
          <div className="p-3 bg-rose-950/80 border border-rose-700/60 rounded-xl text-xs text-rose-300 font-semibold text-center">
            Senha incorreta. Tente novamente (Dica: admin123).
          </div>
        )}

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-bold text-gray-300 mb-1">Senha de Acesso Admin</label>
        ...
        <div className="pt-4 border-t border-white/10 text-center">
          <div className="inline-flex items-center gap-1.5 text-[11px] text-gray-400">
            ...
            <span>Acesso seguro com criptografia local e Supabase Auth</span>
          </div>
        </div>
